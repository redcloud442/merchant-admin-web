        ...
        className={`
          ...
          ${
            isDragActive
              ...
              : "border-gray-500 bg-gray-950 hover:border-gray-400 hover:bg-gray-900"
          }
          ${files.length > 0 ? "border-gray-400 bg-gray-900" : ""}
        `}
            ...
            <>
              <Upload
                className={`w-12 h-12 mx-auto ${
                  isDragActive ? "text-gray-400" : "text-gray-300"
                }`}
              />
              <h3 className="text-sm sm:text-lg font-bold text-gray-100">
                {isDragActive
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2">
            {files.map((file, index) => (
              <div
                key={index}
                className="flex items-center justify-between p-3 bg-gray-50 border border-gray-200 rounded-lg shadow-sm hover:shadow-md hover:bg-gray-100 transition-all"
              >
